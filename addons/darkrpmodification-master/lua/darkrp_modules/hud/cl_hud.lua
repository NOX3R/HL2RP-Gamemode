...
plyMeta.drawPlayerInfo = plyMeta.drawPlayerInfo or function(self)
	...
	if self:Health() >= 20 then
		draw.DrawNonParsedText("Cette "..grade.." est en bonne santé", "DarkRPHUD2", pos.x + 1, pos.y + 21, Color(0, 0, 0, 255), 1)
		draw.DrawNonParsedText("Cette "..grade.." est en bonne santé", "DarkRPHUD2", pos.x, pos.y + 20, Color(20,150,20,200), 1)
	elseif self:Health() >= 10 then
		draw.DrawNonParsedText("Cette "..grade.." est blessée", "DarkRPHUD2", pos.x + 1, pos.y + 21, Color(0, 0, 0, 255), 1)
		draw.DrawNonParsedText("Cette "..grade.." est blessée", "DarkRPHUD2", pos.x, pos.y + 20, Color(255,128,0,200), 1)
	else
		draw.DrawNonParsedText("Cette "..grade.." est dans un état critique", "DarkRPHUD2", pos.x + 1, pos.y + 21, Color(0, 0, 0, 255), 1)
		draw.DrawNonParsedText("Cette "..grade.." est dans un état critique", "DarkRPHUD2", pos.x, pos.y + 20, Color(204,0,0,200), 1)
	end

	if self:isCP() then
		draw.DrawNonParsedText(self:getDarkRPVar("Description") or "C'est une unité de la Protection Civile de Cité 8", "DarkRPHUD2", pos.x + 1, pos.y + 41, Color(0, 0, 0, 255), 1)
		draw.DrawNonParsedText(self:getDarkRPVar("Description") or "C'est une unité de la Protection Civile de Cité 8", "DarkRPHUD2", pos.x, pos.y + 40, Color(255,255,255,200), 1)
	else
		draw.DrawNonParsedText(self:getDarkRPVar("Description") or "C'est un simple citoyen de Cité 8 reconnaissable à sa tenue sale et abimée", "DarkRPHUD2", pos.x + 1, pos.y + 41, Color(0, 0, 0, 255), 1)
		draw.DrawNonParsedText(self:getDarkRPVar("Description") or "C'est un simple citoyen de Cité 8 reconnaissable à sa tenue sale et abimée", "DarkRPHUD2", pos.x, pos.y + 40, Color(255,255,255,200), 1)
	end
end
