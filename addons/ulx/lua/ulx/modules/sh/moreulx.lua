...
jumppower:addParam{ type=ULib.cmds.NumArg, hint="jump power", default=100, min=0.1, max=4000,ULib.cmds.round}
...
sprintspeed:addParam{ type=ULib.cmds.NumArg, hint="speed", default=240, min=0.1, max=5000,ULib.cmds.round}
...
walkspeed:addParam{ type=ULib.cmds.NumArg, hint="speed", default=220, min=1, max=4000,ULib.cmds.round}
