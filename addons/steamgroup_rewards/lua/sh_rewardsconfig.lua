...
REWARDS.Settings.SteamGroupPage = "http://steamcommunity.com/groups/cbutterfly"
...
REWARDS.Settings.GroupName = "Communauté Butterfly"
...
REWARDS.NoticePrefix = "[STEAM RECOMPENSES]" --Chat notification prefix
REWARDS.JoinButtonText = "Rejoindre Groupe Steam" --Text on join button
...
REWARDS.Settings.RewardsMessage = "Rejoignez notre groupe Steam et obtenez 10 000$!"
--Message box text on success (e.g. explain what rewards we're given)
REWARDS.Settings.RewardsSuccessMessage = "Merci de vous être joint au groupe! Vous avez reçu votre argent!"
--Message box text on check (e.g. explain that a check is happening)
REWARDS.Settings.RewardsJoinCheckMessage = "Vérification de l'appartenance au groupe steam..."
...
REWARDS.Settings.RewardsChatMessage = "A rejoint notre groupe Steam et a reçu une récompense!"
...
REWARDS.Settings.DarkRPCashReward = 10000 --DarkRP Cash Reward (Set to 0 to disable)
